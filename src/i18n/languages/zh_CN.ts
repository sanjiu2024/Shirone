...
export const zh_CN: Translation = {
	...
	[Key.commentsUnavailable]: "评论暂不可用",
	[Key.commentsPost]: "发表",
	[Key.commentsDelete]: "删除",
	[Key.commentsReply]: "回复",
	[Key.commentsEmpty]: "暂无评论",
	[Key.commentsSpam]: "操作太快，请稍后再试",
	[Key.authLoginWithGithub]: "使用 GitHub 登录",
	[Key.authLogout]: "退出登录",
	[Key.authHi]: "你好",
	[Key.adminDashboard]: "管理后台",
