...
export const zh_TW: Translation = {
	...
	[Key.commentsUnavailable]: "評論暫時無法使用",
	[Key.commentsPost]: "發表",
	[Key.commentsDelete]: "刪除",
	[Key.commentsReply]: "回覆",
	[Key.commentsEmpty]: "尚無評論",
	[Key.commentsSpam]: "操作太快，請稍後再試",
	[Key.authLoginWithGithub]: "使用 GitHub 登入",
	[Key.authLogout]: "登出",
	[Key.authHi]: "你好",
	[Key.adminDashboard]: "管理後台",
